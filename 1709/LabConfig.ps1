...
#1..4 | % {"1709Node$_"}  | % { $LABConfig.VMs += @{ VMName = $_ ; Configuration = 'Shared'   ; ParentVHD = 'WinServer1709_G2.vhdx'; SSDNumber = 1; SSDSize=1GB ; HDDNumber = 8  ; HDDSize= 4TB ; MemoryStartupBytes= 1GB ; VMSet= 'SSWin1709' } }
