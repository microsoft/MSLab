...
## Notes
* in version 17623 is performance history missing (internal performance volume is not created). It is expected. It will be added back in next few releases.
...
$LABConfig.ServerVHDs += @{
    ...
    VHDName="Windows_InsiderPreview_Server_VHDX_17623.vhdx";
    Size=40GB
}
