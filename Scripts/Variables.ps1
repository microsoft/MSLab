<#
This configuration is just an example config thats being use in Premier Workshop for SDS. Modify as you wish with examples further in this file or from https://github.com/Microsoft/ws2016lab
#>
