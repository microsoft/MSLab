...
 
    ...
    &"$workdir\Tools\dism\dism" /Add-Package /PackagePath:$workdir\Temp\packages\Microsoft-Microsoft-NanoServer-SecureStartup-Package.cab /Image:$workdir\Temp\mountdir
