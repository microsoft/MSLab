...
1..2 | ForEach-Object {$VMNames="Master-S2D"; $LABConfig.VMs += @{ VMName = "$VMNames$_" ; Configuration = 'S2D' ; ParentVHD = 'Win2019Core_17666.vhdx'; SSDNumber = 0; SSDSize=800GB ; HDDNumber = 12; HDDSize= 4TB ; MemoryStartupBytes= 2GB ; Unattend='DjoinCred' ; <#NestedVirt=$True#>}}
...
#Labconfig
    #clusterconfig
    $Clusters=@()
    $Clusters+=@{Nodes="Master-S2D1","Master-S2D2" ; Name="MasterCluster" ; IP="10.0.0.211" ; Volumenames="MCMirror1","MCMirror2" ; VolumeSize=2TB}
    $Clusters+=@{Nodes="1-S2D1","1-S2D2" ; Name="Cluster1" ; IP="10.0.0.212" ; Volumenames="CL1Mirror1","CL1Mirror2" ; VolumeSize=2TB}
    $Clusters+=@{Nodes="2-S2D1","2-S2D2" ; Name="Cluster2" ; IP="10.0.0.213" ; Volumenames="CL2Mirror1","CL2Mirror2" ; VolumeSize=2TB}
...
Let's create Cluster Set master on "MasterCluster"

````PowerShell
New-ClusterSet -name MyClusterSet -NamespaceRoot MC-SOFS -CimSession MasterCluster -StaticAddress "10.0.0.210"
...
![](/Scenarios/S2D%20and%20Cluster%20Sets/Screenshots/ClusterMembersAdded.png)
